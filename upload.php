        ...
        <?php
			if(!empty($_POST))
			{
				...
				else
				{
					...
					{
						echo '<script language="javascript">alert(" اسف ! الملف موجود ")</script>';
					}
					else
					{
						...
						if (!mysql_query($sql,$con))
							...
							echo '<script language="javascript">alert("تم رفعه ")</script>';
						}
				}
				mysql_close($con);
			}
             ...
             <table class="table table-bordered">
                <tr>
                    ...
                    <td>	<input type="text" name="sub" id="sub" class="input-medium"
					         required autofocus placeholder="Title of the subject"/>	</td> <td>	<label for="sub">العنوان  </label>	</td>
                </tr>
                <tr>

                    <td valign="top" align="left"><input type="text" name="pre" cols="50" rows="10" id="pre"
					placeholder="Type of Presentation"
					class="input-medium" required></textarea></td> <td valign="top" align="left">شرح مختصر :</td>
                </tr>
                <tr>

                    <td><input type="file" name="file" id="file"
                        title="Click here to select file to upload." required /></td> <td><label for="file">الملف </label></td>
                </tr>
                <tr>

				   <td colspan="2" align="center">
				   <input type="submit" class="btn btn-primary" name="upload" id="upload"
				   title="Click here to upload the file." value="رفع الملف " /> </td>
                </tr>
            </table>
